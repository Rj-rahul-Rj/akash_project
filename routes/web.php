...
Route::get('supplier-view-quotation-list/{slug}', 'QuotationresponseController@index')->name('supplier-view-quotation-list');
	Route::post('supplier-view-quotation-list/{slug}', 'QuotationresponseController@supplierReponse')->name('supplier-view-quotation-list');
...
// 	Route::get('/indent-list', 'IndentController@list');
// 	Route::get('/indent-add', 'IndentController@add');
// 	Route::post('/indent-add', 'IndentController@CreatAdd');
// //	Route::post('/indent-product-price', 'IndentController@productPrice');
// 	Route::post('/last-indent-details', 'IndentController@lastindentDetails');
// 	Route::get('/indent-edit/{id}', 'IndentController@edit');
// 	Route::post('/indent-edit/{id}', 'IndentController@update');
// 	Route::post('/indent-delete/{id}', 'IndentController@delete');
	
// 	Route::get('/indent-track', 'IndentController@track');
// 	Route::get('/product_quantity_alert_indent/{id}', 'IndentController@productquantityAlertindent');
// 	Route::get('/indent-edit/{id}', 'IndentController@edit');
// 	Route::get('/inward', 'IndentController@inward');
// 	Route::post('/inward', 'IndentController@inwardCreate');

	Route::get('indent-track', 'IndentController@track')->name('indent-track');
	Route::get('indent-list', 'IndentController@list')->name('indent-list');
	Route::get('indent-add', 'IndentController@add')->name('indent-add');
	Route::post('indent-create', 'IndentController@CreatAdd')->name('indent-create');
	// Route::post('indent-product-price', 'IndentController@productPrice')->name('indent-product-price');
    Route::post('last-indent-details', 'IndentController@lastindentDetails')->name('last-indent-details');
	Route::get('product_quantity_alert_indent/{id}', 'IndentController@productquantityAlertindent')->name('product_quantity_alert_indent');
	Route::get('indent-edit/{id}', 'IndentController@edit')->name('indent-edit');
    Route::post('indent-edit/{id}', 'IndentController@update')->name('indent-edit');
	Route::post('indent-delete/{id}', 'IndentController@delete')->name('indent-delete');

	Route::get('inward', 'IndentController@inward')->name('inward');
	Route::post('inward', 'IndentController@inwardCreate')->name('inward');

	Route::resource('productdepartments', 'ProductDepartmentController');
	
	
	
	Route::post('reconciliation-show', 'ReconciliationController@reconciliationShow');
	Route::post('reconciliation-accept', 'ReconciliationController@reconciliationAccept');
	Route::post('reconciliation-reject', 'ReconciliationController@reconciliationReject');
	Route::resource('reconciliation', 'ReconciliationController');
	
	Route::get('repair-and-maintenance', 'RepairmaintenanceController@index')->name('repair-and-maintenance');
	Route::post('repair-and-maintenance-add', 'RepairmaintenanceController@create')->name('repair-and-maintenance-add');
	Route::get('repair-and-maintenance-edit/{id}', 'RepairmaintenanceController@edit')->name('repair-and-maintenance-edit');
	Route::post('repair-and-maintenance-delete/{id}', 'RepairmaintenanceController@delete')->name('repair-and-maintenance-delete');
