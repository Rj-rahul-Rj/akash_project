    ...
    <div id="loader"></div>
      ...
      <nav class="side-navbar">
        <span class="brand-big">
            ...
            <a href="{{url('/')}}"><!-- Reom-->
      <img src="{{url('public/logo', $general_setting->site_logo)}}" width="100">
      </a>
            @else
        ...
        <ul id="side-main-menu" class="side-menu list-unstyled">
            ...
            <li><a href="#sale" aria-expanded="false" data-toggle="collapse"> <i class="dripicons-card"></i><span>{{trans('Indent')}}</span></a><!-- "file.Sale"-->
            <ul id="sale" class="collapse list-unstyled ">
                ...
                -->
                <!--<li id="sale-create-menu"><a href="{{route('sales.create')}}">{{trans('Add Indent')}}</a></li> <!-- "file.Add Sale"-->
                <li id="sale-create-menu"><a href="/indent-list">{{trans('Indent')}}</a></li>
                <li id="sale-create-menu"><a href="/indent-track">{{trans('Track Indent')}}</a></li> 
                <li id="sale-create-menu"><a href="/inward">{{trans('Inward')}}</a></li> 
                <!--
            ...
            @endif
              ...
              <li><a href="{{route('reconciliation.index')}}"> <i class="dripicons-meter"></i><span>reconciliation</span></a></li>
                
                <li><a href="{{route('repair-and-maintenance')}}"> <i class="dripicons-meter"></i><span>repair</span></a></li>
            <?php
                $index_permission_active = DB::table('permissions')
                    ->join('role_has_permissions', 'permissions.id', '=', 'role_has_permissions.permission_id')
                    ->where([
...
-->
            ...
            <li><a href="#setting" aria-expanded="false" data-toggle="collapse"> <i class="dripicons-gear"></i><span>{{trans('file.settings')}}</span></a>
                <ul id="setting" class="collapse list-unstyled ">
                    ...
                    <li id="productdepartments-menu"><a href="{{route('productdepartments.index')}}">Product Departments</a></li>
                   <!-- endif -->
