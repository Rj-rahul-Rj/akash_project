                    ...
                    <div class="card-body">
                        ...
                        <form id="product-form">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <input type="hidden" name="whouse" value="{{$lims_product_data->whouse_id}}">
                                        <label>{{trans('file.Warehouse')}} *</strong> </label>
                                        <div class="input-group">
                                          <select name="whouse_id" required class="selectpicker form-control" data-live-search="true" data-live-search-style="begins" title="Select Warehouse...">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <input type="hidden" name="departments" value="{{$lims_product_data->product_dept_id}}">
                                        <label>{{trans('file.Department')}} *</strong> </label>
                                        <div class="input-group">
                                          <select name="product_dept_id" required class="selectpicker form-control" data-live-search="true" data-live-search-style="begins" title="Select Product Department...">
                                            @foreach($lims_product_epartment_list as $pdept)
...
<script type="text/javascript">
    ...
    var who = $("input[name='whouse']").val();
    $('select[name=whouse_id]').val(who);
   
    var pdept = $("input[name='departments']").val();
    $('select[name=product_dept_id]').val(pdept);
