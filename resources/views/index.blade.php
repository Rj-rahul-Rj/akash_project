            ...
            <div class="col-md-7 mt-4">
              <div class="card line-chart-example">
                ...
                <div class="card-body">
                  ...
                  <!--NEW-->
                  <canvas id="cashFlow" data-color = "{{$color}}" data-color_rgba = "{{$color_rgba}}" data-recieved = "{{json_encode($payment_recieved)}}" data-month = "{{json_encode($month)}}" data-label1="{{trans('file.Payment Recieved')}}" ></canvas>
                  <!--NEW-->
