...
class ProductController extends Controller
{
    public function index()
    {
        ...
        if($role->hasPermissionTo('products-index')){            
            ...
            $role_id = $role->id;
            return view('product.index', compact('all_permission', 'role_id'));
        }
        else
    ...
    public function create()
    {
        ...
        if ($role->hasPermissionTo('products-add')){
            ...
            $lims_product_epartment_list = ProductDepartment::where('is_active', true)->get();
            return view('product.create',compact('lims_product_list_without_variant', 'lims_product_list_with_variant', 'lims_brand_list', 'lims_category_list', 'lims_unit_list', 'lims_tax_list', 'lims_warehouse_list','lims_product_epartment_list'));
        }
        else
            return redirect()->back()->with('not_permitted', 'Sorry! You are not allowed to access this module');
    }
    ...
    public function history(Request $request)
    {
        ...
        if($role->hasPermissionTo('sales-index')) {
            ...
            $lims_warehouse_list = Warehouse::where('is_active', true)->get();
            return view('product.history',compact('starting_date', 'ending_date', 'warehouse_id', 'product_id', 'product_data', 'lims_warehouse_list'));
        }
        else
            return redirect()->back()->with('not_permitted', 'Sorry! You are not allowed to access this module');
    }
    ...
    public function edit($id)
    {
        ...
        if ($role->hasPermissionTo('products-edit')) {
            ...
            return view('product.edit',compact('lims_product_list_without_variant', 'lims_product_list_with_variant', 'lims_brand_list', 'lims_category_list', 'lims_unit_list', 'lims_tax_list', 'lims_product_data', 'lims_product_variant_data', 'lims_warehouse_list', 'noOfVariantValue','lims_product_epartment_list'));
        }
        else
            return redirect()->back()->with('not_permitted', 'Sorry! You are not allowed to access this module');
    }
    ...
    public function printBarcode(Request $request)
    {
        ...
        return view('product.print_barcode', compact('lims_product_list_without_variant', 'lims_product_list_with_variant', 'preLoadedproduct'));
    }
