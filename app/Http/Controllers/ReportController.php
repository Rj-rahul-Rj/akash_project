...
class ReportController extends Controller
{
    public function productQuantityAlert()
    {
        ...
        if($role->hasPermissionTo('product-qty-alert')){
            $lims_product_data = Product::select('name','code', 'image', 'qty', 'alert_quantity','id')->where('is_active', true)->whereColumn('alert_quantity', '>', 'qty')->get();
    ...
    public function supplierDueReportByDate(Request $request)
    {
        ...
        return view('report.supplier_due_report', compact('lims_purchase_data', 'start_date', 'end_date'));
    }
}
